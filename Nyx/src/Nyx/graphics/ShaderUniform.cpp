...
namespace Nyx  {
	...
	ShaderUniform::ShaderUniform(const std::string& name, UniformType type, uint size, uint offset, RendererID rendererID)
	...
	const std::string& ShaderUniform::UniformTypeToString(UniformType type)
	{
